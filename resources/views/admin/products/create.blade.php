...
@section('title', 'Nuevo Producto - Lumina Admin')
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="category" placeholder="Ej: Cuidado Capilar"
                                class="w-full rounded-lg border-gray-300 focus:border-teal-500 focus:ring-teal-500">
                        </div>
                        <div>
                    ...
                    <div class="border-t border-gray-100 pt-6 flex justify-end gap-3">
                        ...
                        <button type="submit"
                            class="px-4 py-2 text-sm font-bold text-white bg-teal-600 hover:bg-teal-700 rounded-lg shadow">Guardar
                            Producto</button>
                    </div>
                </div>
            </form>
